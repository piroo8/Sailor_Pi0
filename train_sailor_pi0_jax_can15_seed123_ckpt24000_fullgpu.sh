#!/bin/bash
#SBATCH --job-name=sailor_pi0_can15_ckpt24000_full_8d_diff
#SBATCH --output=/home/ishakpie/projects/def-rhinehar/ishakpie/logs/sailor_pi0_can15_ckpt24000_full_8d_diff_%j.out
#SBATCH --error=/home/ishakpie/projects/def-rhinehar/ishakpie/logs/sailor_pi0_can15_ckpt24000_full_8d_diff_%j.err
...
JOB_NAME=sailor_pi0_can15_ckpt24000_full_8d_diff
CHECKPOINT_ROOT=/SAILOR/scratch_dir/checkpoints/pi0_droid_robomimic_hdf5/can15_seed123_48000
CHECKPOINT="${CHECKPOINT_ROOT}/24000"
SELECTED_DEMOS_MANIFEST="${CHECKPOINT_ROOT}/selected_demos.json"
DATASET=/SAILOR/datasets/robomimic_datasets/can/ph/image_224_shaped_done1_v141.hdf5
TASK=robomimic__can
PROMPT="Lift can and place in correct bin."
: "${TRAIN_SEED:=108}"
WANDB_EXP_NAME=can15_24000
: "${RESUME_RUN_LOGDIR:=}"
: "${SAILOR_AUTO_CHAIN:=1}"
...
WORKER_SCRIPT_PATH="${SAILOR_HOST_DIR}/train_sailor_pi0_jax_can15_seed123_ckpt24000_fullgpu.sh"
