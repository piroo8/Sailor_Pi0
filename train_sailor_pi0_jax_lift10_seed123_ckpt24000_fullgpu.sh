#!/bin/bash
#SBATCH --job-name=sailor_pi0_lift10_ckpt24000_full_8d_diff
#SBATCH --output=/home/ishakpie/projects/def-rhinehar/ishakpie/logs/sailor_pi0_lift10_ckpt24000_full_8d_diff_%j.out
#SBATCH --error=/home/ishakpie/projects/def-rhinehar/ishakpie/logs/sailor_pi0_lift10_ckpt24000_full_8d_diff_%j.err
...
JOB_NAME=sailor_pi0_lift10_ckpt24000_full_8d_diff
CHECKPOINT_ROOT=/SAILOR/scratch_dir/checkpoints/pi0_droid_robomimic_hdf5/lift10_seed123_48000
...
WORKER_SCRIPT_PATH="${SAILOR_HOST_DIR}/train_sailor_pi0_jax_lift10_seed123_ckpt24000_fullgpu.sh"
